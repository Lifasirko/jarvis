...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sites', '0007_profile_remove_contact_user_delete_news_and_more.py'),  # Залежить від вашої структури міграцій
        ('socialaccount', '0008_auto_20240731_1432.py'),  # Залежить від вашої структури міграцій
    ]
